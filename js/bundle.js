  ...
  const exportCSV = () => {
    ...
    const rows = monthQuotes.map(q => {
      ...
      return [
        ...
        Math.round((q.totalWeight||0) * 10) / 10,
        Math.round((gramsByGroup.cadena||0) * 10) / 10,
        Math.round((gramsByGroup.micro||0) * 10) / 10,
        Math.round((gramsByGroup.italiana||0) * 10) / 10,
        Math.round((gramsByGroup.gf18k||0) * 10) / 10,
        total,
